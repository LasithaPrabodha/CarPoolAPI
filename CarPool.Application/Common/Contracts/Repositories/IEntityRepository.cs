...
/// <summary>
/// Interface for generic repository for domain entities. See <see cref="Entity{TId}"/>.
/// Inherits from <see cref="IReadRepository{T}"/> and <see cref="IWriteRepository{T}"/>
/// </summary>
/// <typeparam name="T"></typeparam>
/// <typeparam name="TId"></typeparam>
public interface IEntityRepository<T, TId> : IReadRepository<T>, IWriteRepository<T> where T : class, IAggregateRoot
{
    /// <summary>
